const hasLabField = document.getElementById('evaluation_update_hasLab');
...
const usaField = document.getElementById('evaluation_update_locatedUsa');
const usaLabel = document.querySelector('label[for="evaluation_update_locatedUsa"]');
const stateField = document.getElementById('evaluation_update_state');
const stateLabel = document.querySelector('label[for="evaluation_update_state"]');
const institutionField = document.getElementById('evaluation_update_institution');
const institutionLabel = document.querySelector('label[for="evaluation_update_institution"]');
const listedField = document.getElementById('evaluation_update_institutionListed');
const listedLabel = document.querySelector('label[for="evaluation_update_institutionListed"]');
const countryField = document.getElementById('evaluation_update_country');
const countryLabel = document.querySelector('label[for="evaluation_update_country"]');
const institutionNameField = document.getElementById('evaluation_update_institutionName');
const institutionNameLabel = document.querySelector('label[for="evaluation_update_institutionName"]');
const institutionNameHelp = document.getElementById('evaluation_update_institutionName_help');
