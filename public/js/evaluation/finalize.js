const addNoteField = document.getElementById('evaluation_finalize_addNote');
...
const eqvCnt = document.getElementById('evaluation_finalize_eqvCnt');
...
const eqv1SubjCode = document.getElementById('evaluation_finalize_eqv1SubjCode');
const eqv1 = document.getElementById('evaluation_finalize_eqv1');
...
const eqv2SubjCode = document.getElementById('evaluation_finalize_eqv2SubjCode');
const eqv2 = document.getElementById('evaluation_finalize_eqv2');
...
const eqv3SubjCode = document.getElementById('evaluation_finalize_eqv3SubjCode');
const eqv3 = document.getElementById('evaluation_finalize_eqv3');
...
const eqv4SubjCode = document.getElementById('evaluation_finalize_eqv4SubjCode');
const eqv4 = document.getElementById('evaluation_finalize_eqv4');
