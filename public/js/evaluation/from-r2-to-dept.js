const addNoteField = document.getElementById('evaluation_from_r2_to_dept_addNote');
...
document.addEventListener('DOMContentLoaded', function () {
  const deptSelect = document.getElementById('evaluation_from_r2_to_dept_dept');
  const assigneeSelect = document.getElementById('evaluation_from_r2_to_dept_assignee');
