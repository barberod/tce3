const addNoteField = document.getElementById('evaluation_assign_addNote');
...
document.addEventListener('DOMContentLoaded', function () {
  const deptSelect = document.getElementById('evaluation_assign_dept');
  const assigneeSelect = document.getElementById('evaluation_assign_assignee');
