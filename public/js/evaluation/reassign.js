const addNoteField = document.getElementById('evaluation_reassign_addNote');
...
document.addEventListener('DOMContentLoaded', function () {
  const deptSelect = document.getElementById('evaluation_reassign_dept');
  const assigneeSelect = document.getElementById('evaluation_reassign_assignee');
